...
export const addJob = async (req, res, next) => {
	try {
		const { title, description, location, requirements, employmentType, industry, maxSalary, minSalary, benefits, categories, tags, remote, views, applicationDeadline, status, experienceLevel, postedBy, isSyncedToElastic  } =
			req.body
      ...
      !industry ||
		...
		const newJob = new Job({
			title, description, location, requirements, employmentType, experienceLevel, industry, maxSalary, minSalary, benefits, categories, tags, remote, views, applicationDeadline, status, postedBy: req.userId, isSyncedToElastic
		})
		await newJob.save()
...
export const jobs = async (req, res, next) => {
  try {
    ...
    // Filter by experienceLevel type
    if (experienceLevel) {
      pipeline.push({
